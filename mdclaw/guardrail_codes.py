...
GUARDRAIL_CODES: dict[str, str] = {
    ...
    "abfe_restraint_unstable": "The ligand does not hold its pose in the equilibrated complex, so no restraint was written. Extend equilibration with an eq -> eq node and run add_boresch_restraint under the new eq; if it still fails, report that the pose is not stable.",
