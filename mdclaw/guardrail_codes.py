...
GUARDRAIL_CODES: dict[str, str] = {
    ...
    "solvent_density_below_bulk_outside_bilayer": "The assembled cell holds far less water than bulk density outside the bilayer.",
    "solvent_density_void_outside_bilayer": "The assembled cell has a near-empty solvent region outside the bilayer.",
