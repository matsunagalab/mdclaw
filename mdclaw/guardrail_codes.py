...
GUARDRAIL_CODES: dict[str, str] = {
    ...
    "distance_steering_invalid": "Supply distance restraints and positive steering times of at least one timestep.",
    "distance_steering_restart_mismatch": "Use matching XML and steering.json with the original schedule and restraints.",
