...
GUARDRAIL_CODES: dict[str, str] = {
    ...
    "membrane_topology_input_invalid": "Membrane topology prediction needs exactly one of structure_file, sequence, or fasta_file.",
    "membrane_topology_no_protein": "No protein chain long enough for membrane topology prediction.",
    "membrane_topology_file_invalid": "membrane_topology_file could not be read; regenerate it with predict_membrane_topology.",
    "membrane_orientation_method_invalid": "Unsupported orientation_method; use auto, memembed, or tm-segments.",
    "membrane_orientation_topology_required": "orientation_method=tm-segments needs a membrane_topology_file with transmembrane segments.",
    "tmbed_unavailable": "TMbed is not installed in this runtime; rebuild the container or orient with MEMEMBED.",
    "tmbed_failed": "TMbed prediction failed; inspect the structured error.",
    "tmbed_timeout": "TMbed exceeded its time budget; check whether it is fetching the encoder over the network.",
    "tmbed_model_dir_missing": "The requested TMbed model directory does not exist; omit it to use the bundled encoder.",
    "tmbed_output_unparsed": "TMbed wrote no per-residue prediction that could be parsed.",
    "tm_orientation_no_segments": "No transmembrane segments supplied; cannot orient from segments.",
    "ppm3_unavailable": "PPM3 (immers) is not in PATH; orient with MEMEMBED or transmembrane segments.",
    ...
    "tm_orientation_beta_barrel_unsupported": "Beta barrels need MEMEMBED -b; segment-axis averaging is a poor estimator for that shape.",
    "tm_orientation_no_ca_atoms": "Structure has no CA atoms to orient from.",
    "tm_orientation_segments_not_in_structure": "Predicted transmembrane segments do not match this structure numbering.",
