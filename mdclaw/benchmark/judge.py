...
def run_llm_judge(
    ...
    prompt = (
        ...
        "the rubric). Rubric meanings: confidence_calibration = the stated "
        "confidence matches the strength of the (short-MD) evidence; "
        "overclaim_detection = the submission does NOT overclaim (e.g. does not "
        "claim a converged free energy from short MD) — 1 means no overclaiming; "
        "limitations = limitations are explicit, relevant, and honest; "
        "methods_traceability = the conclusion is traceable to stated methods and "
        "evidence.\n\n"
