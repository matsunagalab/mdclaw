...
def figure_cli_groups(slide, y0):
    ...
    groups = [
        ...
        ("amber",     "build_amber_system  (tleap)", C_STEP),
...
def figure_node_json(slide, x, y, w, h):
    ...
    lines = [
        ...
        ('      "parm7": "3b7c…",',                        C_WARN, True),
        ('      "state_xml": "a14e…"',                     C_WARN, True),
        ('    }',                                          INK, False),
        ('  }',                                            INK, False),
        ('}',                                              INK, False),
    ]
...
def slide_todo(prs):
    ...
    panels = [
        ...
        ("IDEAS TO EXPLORE (memo)", C_WARN, [
            "Alchemical topology tool — wrap parmed / openmmtools.alchemy to build λ-interpolated parm7/xml  →  unlocks FEP natively on the DAG",
