...
TASKS: dict[str, dict] = {
    ...
    "P35": {
        "task_full_id": "P35_prep_rna_structural_mg_1y26",
        "pdb_id": "1Y26", "fmt": "pdb",
        "prep": {"include-types": ["nucleic", "ion"],
                 "solvent-type": "explicit"},
        "regime": "explicit",
    },
    "P36": {
        "task_full_id": "P36_prep_protein_rna_complex_1a1t",
        "pdb_id": "1A1T", "fmt": "pdb",
        "prep": {"solvent-type": "explicit", "source-model-index": 1,
                 "include-types": ["protein", "nucleic", "ion"]},
        "regime": "explicit",
    ...
    "P37": {
        "task_full_id": "P37_prep_beta_barrel_membrane_1bxw",
        "pdb_id": "1BXW", "fmt": "pdb",
        "prep": {"select-chains": ["A"], "solvent-type": "explicit",
                 "include-types": ["protein"]},
        "regime": "membrane",
        "membrane": {"lipids": "POPC", "dist": "15.0",
                     "dist-wat": "17.5", "saltcon": "0.15",
                     "membrane-carve-padding": "3.0"},
        "topo": {"is-membrane": True},
    },
    "P38": {
        "task_full_id": "P38_prep_implicit_complex_mdm2_p53_1ycr",
        "pdb_id": "1YCR", "fmt": "pdb",
        "prep": {"select-chains": ["A", "B"], "solvent-type": "implicit",
                 "include-types": ["protein"]},
        "regime": "implicit",
        "topo": {"forcefield": "ff14SB", "implicit-solvent": "GBn2"},
    },
    "P39": {
        "task_full_id": "P39_prep_potassium_channel_membrane_1bl8",
        "pdb_id": "1BL8", "fmt": "cif", "assembly_ids": ["1"],
        "prep": {"solvent-type": "explicit", "source-candidate-id": "candidate_002",
                 "include-types": ["protein", "ion"]},
        "regime": "membrane",
        "membrane": {"lipids": "POPC", "dist": "15.0",
                     "dist-wat": "17.5", "saltcon": "0.15"},
    ...
    "P40": {
        "task_full_id": "P40_prep_tip3p_water_fidelity_2lzm",
        "pdb_id": "2LZM", "fmt": "pdb",
        "prep": {"select-chains": ["A"], "solvent-type": "explicit"},
        "regime": "explicit",
        "solvate": {"water-model": "tip3p"},
        "topo": {"forcefield": "ff14SB", "water-model": "tip3p"},
        "ff": "ff14SB", "water": "tip3p",
    },
}
