...
1. Run `mdclaw inspect_job --job-dir <job_dir>` and check pending, running,
   failed, claimed, and leaf nodes. Use the current stage skill and study plan
   to decide which node/tool to run next.
