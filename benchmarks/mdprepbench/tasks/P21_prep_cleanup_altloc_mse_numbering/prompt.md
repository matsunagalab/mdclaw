# P21_prep_cleanup_altloc_mse_numbering: MD system preparation

You are evaluating an MD agent on `P21_prep_cleanup_altloc_mse_numbering`.

Use this prompt as the task statement. Retrieve public sources as needed, and do not read `truth/` or `scorer/` if those directories exist.

Task: MSE cleanup: convert deposited MSE residues to standard MET, exclude unrequested nonstandard residues, and build a minimized MD-ready system.
