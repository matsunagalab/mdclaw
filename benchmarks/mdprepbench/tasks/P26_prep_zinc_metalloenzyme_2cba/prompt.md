# P26_prep_zinc_metalloenzyme_2cba: Zinc metalloenzyme preparation

You are evaluating an MD agent on `P26_prep_zinc_metalloenzyme_2cba`.

Use this prompt as the task statement. Retrieve public sources as needed, and do not read `truth/` or `scorer/` if those directories exist.

Task: Zinc metalloenzyme preparation: prepare human carbonic anhydrase II from PDB 2CBA while retaining the single catalytic Zn2+ as a supported metal ion and keeping its His94/His96/His119 coordination shell, rather than dropping the zinc or treating it as a generic ligand. Neutralize the resulting system.
