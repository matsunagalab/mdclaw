# P31_prep_his_protonation_hip_t4l: MD system preparation

You are evaluating an MD agent on `P31_prep_his_protonation_hip_t4l`.

Use this prompt as the task statement. Retrieve public sources as needed, and do not read `truth/` or `scorer/` if those directories exist.

Task: Site-specific histidine protonation: prepare T4 lysozyme (PDB 2LZM) so chain A residue His31 is built as the doubly protonated HIP tautomer (both HD1 and HE2 present), overriding the default neutral-histidine tautomer assignment.
